...
from lesson.session import (
    available_section_numbers,
    build_answer_messages,
    build_teach_section_messages,
    get_current_section_number,
    get_navigation_target_section,
)
...
from streaming.audio_events import process_streaming_buffer
